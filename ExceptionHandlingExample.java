...
public class ExceptionHandlingExample {
	...
	// Checked exception happens during your compilation time, in the scenario file
	// IO is the excpetion thrown
	...
	public static void main(String args[]) {
		...
		int f = 10;
		if(e>f)
		{	//Throw keyword is used to throw single expceion on the program based on our condition
